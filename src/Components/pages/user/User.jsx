        ...
        <div className="userShow">
          <div className="userShowTop">
            ...
            <div className="userShowTopTitle">
              <span className="userShowUsername">Raza</span>
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">razaShah</span>
            </div>
            <div className="userShowInfo">
              <CalendarToday className="userShowIcon" />
              <span className="userShowInfoTitle">18 Dec 1999</span>
            </div>
            <span className="userShowTitle">Contact details</span>
            <div className="userShowInfo">
              <PhoneAndroid className="userShowIcon" />
              <span className="userShowInfoTitle">+923420518053</span>
            </div>
            <div className="userShowInfo">
              <EmailOutlined className="userShowIcon" />
              <span className="userShowInfoTitle">razaShah89@gmail.com</span>
            </div>
            <div className="userShowInfo">
              <LocationSearching className="userShowIcon" />
              <span className="userShowInfoTitle">Chakwal|Pakistan</span>
            </div>
          </div>
        </div>
          ...
          <form action="" className="userUpdateForm">
            <div className="userUpdateLeft">
              ...
              <div className="userUpdateItem">
                ...
                <input
                  type="text"
                  placeholder="razaShah89@gmail.com"
                  className="userUpdateInput"
                />
              </div>
